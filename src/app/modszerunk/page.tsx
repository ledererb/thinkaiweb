...
const phases = [
  {
    number: "01",
    title: "Teljeskörű szervezeti audit",
    color: "#12bbbc",
    subtitle: "Szervezet alapos átvilágítása",
    blocks: [
      {
        heading: "Dokumentáció- és adatbázis-elemzés",
        items: [
          "Dokumentáció- és adatbázis-elemzés",
          "Szervezeti, üzleti, és munkafolyamatok feltérképezése",
          "IT-környezet vizsgálata a meglévő infrastrukturális kapacitások felméréséhez",
        ],
      },
      {
        heading: "AI alkalmazhatóságának vizsgálata",
        items: [
          "Előzetes becslések az igényekhez legmegfelelőbb módszerekről és eszközökről",
          "Hatékonyság- és költségelemzések elvégzése",
          "Jogszabályi megfelelés, szervezeti változások, és HR-vonatkozások figyelembevétele",
        ],
      },
    ],
  },
  {
    ...
    title: "AI-stratégia",
    color: "#3b82f6",
    subtitle: "Rövid- és középtávú javaslatok kidolgozása",
    blocks: [
      {
        heading: "Folyamatoptimalizáció",
        items: [
          "AI-alapú folyamatoptimalizációk bevezetésére vonatkozó ajánlások",
        ],
      },
      {
        heading: "Fejlesztési terv készítése",
        items: [
          "Automatizációk bevezetésére irányuló terv",
          "Megtérülési kalkulációk",
          "Változásmenedzsment javaslatok",
        ],
      },
      {
        heading: "Adatmenedzsment és adatminőség fejlesztése",
        items: [
          "Az AI-megoldásokhoz szükséges adatok elemzése és rendszerezése",
          "Adatgyűjtési és -tárolási gyakorlatok optimalizálása",
          "Az adatminőség javítására irányuló javaslatok kidolgozása",
        ],
      },
    ],
  },
  {
    ...
    title: "Fejlesztés",
    color: "#10b981",
    subtitle: "Technológiai megoldások megvalósítása",
    blocks: [
      {
        heading: "Technológiai megoldások integrálása",
        items: [
          "A kiválasztott AI-technológiák zökkenőmentes beillesztése a meglévő IT-infrastruktúrába",
        ],
      },
      {
        heading: "Munkavállalók és vezetők támogatása",
        items: [
          "Felkészítés az új rendszerek kezelésére",
          "Magabiztosság növelése a technológia használatában",
          "Hatékony munkafolyamatok kialakításának segítése",
        ],
      },
    ],
  },
  {
    ...
    title: "Támogatás",
    color: "#8b5cf6",
    subtitle: "Hosszú távú fenntarthatóság biztosítása",
    blocks: [
      {
        heading: "Technológia folyamatos figyelemmel kísérése",
        items: [
          "AI-megoldások rendszeres frissítése és továbbfejlesztése",
          "Korszerű, hatékony AI-eszközök biztosítása ügyfelek számára",
        ],
      },
      {
        heading: "Felhasználói támogatás és oktatás",
        items: [
          "A felhasználók zökkenőmentes alkalmazkodásának elősegítése az új rendszerekhez",
          "Támogató szolgáltatások és képzések nyújtása",
        ],
      },
    ],
  },
...
export default function ModszerunkPage() {
  return (
    <>
      <Navigation />
      <main>
        ...
        <section className="method-hero">
          ...
          <div className="container hero-inner">
            <span className="hero-tag">Módszerünk</span>
            <h1>
              Az AI-transzformáció <br />
              <span className="highlight">teljes életciklusa</span>
            </h1>
            <p className="lead">
              Az AI-megoldások bevezetésétől a hosszú távú fenntartásig terjedő
              átfogó szolgáltatás biztosítása — lépésről lépésre, a
              vállalkozásodhoz igazítva.
            </p>
          </div>
        </section>
        ...
        <section className="method-section section-white">
          <div className="container">
            <h2 className="section-heading">Audit & Stratégia</h2>
            <p className="section-sub">Megértjük a szervezetedet és kidolgozzuk a stratégiát</p>
        ...
        <section className="method-section section-dark">
          <div className="container">
            <h2 className="section-heading">Fejlesztés & Támogatás</h2>
            <p className="section-sub">Megvalósítjuk és fenntartjuk a megoldásokat</p>
            <div className="phases-wrapper">
        ...
        <section className="method-section section-white">
          <div className="container">
            <h2 className="section-heading">Amit garantálunk</h2>
            <div className="summary-grid">
              <div className="summary-card">
                ...
                <h3>Hatékonyság</h3>
                <p>Automatizált folyamatok, kevesebb manuális munka</p>
              </div>
              <div className="summary-card">
                <div className="summary-icon">
                ...
                <h3>Megtérülés</h3>
                <p>Adatvezérelt döntések, mérhető eredmények</p>
              </div>
              <div className="summary-card">
                <div className="summary-icon">
                ...
                <h3>Biztonság</h3>
                <p>Jogszabályi megfelelés, adatvédelem</p>
              </div>
              <div className="summary-card">
                <div className="summary-icon">
                ...
                <h3>Támogatás</h3>
                <p>Folyamatos karbantartás és fejlesztés</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="guarantee-box">
              <div className="guarantee-content">
                <h3>100% Pénzvisszafizetési Garancia</h3>
                <p>
                  Ha nem tetszik az audit eredménye, kérdés nélkül
                  visszafizetjük az árát. Kockázatmentesen próbálhatja ki
                  módszerünket.
                </p>
              </div>
            </div>
            ...
            <div className="cta-block">
              <h2>Készen állsz az első lépésre?</h2>
              <p>
                Kérj díjmentes konzultációt, és derítsd ki, hogyan
                automatizálhatod folyamataidat AI-val.
              </p>
              <div className="cta-buttons">
                <a href="/#ajanlatkeres" className="btn btn-large btn-primary">
                  Ingyenes konzultáció
                </a>
                <a href="/palyazat" className="btn btn-large btn-outline">
      ...
      <style jsx>{`
        ...
        .section-heading {
          text-align: center; font-size: clamp(1.6rem,3.5vw,2.2rem); margin-bottom: 0.8rem;
        }
        ...
        .phase-number {
          ...
          box-shadow: 0 0 20px color-mix(in srgb, var(--phase-color) 40%, transparent);
          z-index: 1;
        }
        ...
        .section-white .block-card:hover {
        ...
        .section-dark .block-card:hover {
          background: rgba(255,255,255,0.06); border-color: var(--phase-color);
        ...
        .block-card li {
          ...
          padding: 6px 0; font-size: 0.9rem; line-height: 1.6;
        }
